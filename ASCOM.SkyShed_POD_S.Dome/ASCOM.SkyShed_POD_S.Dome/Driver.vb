...
'
' ASCOM Dome driver for SkyShed_POD_S
'
...
'
'
' Your driver's ID is ASCOM.SkyShed_POD_S.Dome
'
...
<Guid("3f62b5b8-d198-4a0a-b6ab-6c01a19f5928")>
<ClassInterface(ClassInterfaceType.None)>
Public Class Dome

    ' The Guid attribute sets the CLSID for ASCOM.SkyShed_POD_S.Dome
    ' The ClassInterface/None attribute prevents an empty interface called
    ' _SkyShed_POD_S from being created and used as the [default] interface
    ...
    '
    Friend Shared driverID As String = "ASCOM.SkyShed_POD_S.Dome"
    Private Shared driverDescription As String = "SkyShed_POD_S Dome"
    ...
    Public Sub New()
        ...
        TL = New TraceLogger("", "SkyShed_POD_S")
...
#Region "Common properties and methods"
    ...
    Public ReadOnly Property SupportedActions() As ArrayList Implements IDomeV2.SupportedActions
        Get
            Dim x As Int32
            Dim features As ArrayList = New ArrayList()
            Dim s As String
            Dim match As Int32
            ...
            Do
                ...
                s = s.Replace("#", "")
                match = String.Compare(s, "endoflist")
                If match <> 0 Then
                    features.Add(s)
                End If
                x = x + 1
    ...
    Public ReadOnly Property DriverInfo As String Implements IDomeV2.DriverInfo
        Get
            ...
            Dim s_driverInfo As String = "POD-S Dome Control: Driver version: " + m_version.Major.ToString() + "." + m_version.Minor.ToString()
...
#Region "IDome Implementation"
    ...
    Public ReadOnly Property ShutterStatus() As ShutterState Implements IDomeV2.ShutterStatus
        Get
            ...
            If (String.Compare(s, "Open#") = 0) Then
    ...
    Public Property Slaved() As Boolean Implements IDomeV2.Slaved
        Get
            CheckConnected("SlavedGet")
            objSerial.Transmit("$GetSlaved#")
            Dim s As String
            s = objSerial.ReceiveTerminated("#")
            TL.LogMessage("Get Slaved", s)
            Dim retBool As Boolean = False
            If String.Compare(s, "True#") = 0 Then
                retBool = True
            End If
